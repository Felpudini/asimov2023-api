...
@Component
public class JwtHandlerTeacher {
    private static final Logger logger = LoggerFactory.getLogger(JwtHandlerTeacher.class);
    ...
    public String generateToken(Authentication authentication) {
        ...
        String subject = ((TeacherDetailsImpl) authentication.getPrincipal()).getEmail();
