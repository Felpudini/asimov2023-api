...
@Component
public class JwtHandlerDirector {
    private static final Logger logger = LoggerFactory.getLogger(JwtHandlerDirector.class);
    ...
    public String generateToken(Authentication authentication) {
        ...
        String subject = ((DirectorDetailsImpl) authentication.getPrincipal()).getEmail();
