...
import com.cybersoft.asimovapi.directors.service.DirectorServiceImpl;
...
public class JwtAuthorizationFilterDirector extends OncePerRequestFilter {
    private static final Logger logger = LoggerFactory.getLogger(JwtAuthorizationFilterDirector.class);

    @Autowired
    private JwtHandlerDirector handler;

    @Autowired
    private DirectorServiceImpl userService;
