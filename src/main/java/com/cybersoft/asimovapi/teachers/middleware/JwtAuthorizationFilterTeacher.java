...
import com.cybersoft.asimovapi.teachers.service.TeacherServiceImpl;
...
public class JwtAuthorizationFilterTeacher extends OncePerRequestFilter {
    private static final Logger logger = LoggerFactory.getLogger(JwtAuthorizationFilterTeacher.class);

    @Autowired
    private JwtHandlerTeacher handler;
